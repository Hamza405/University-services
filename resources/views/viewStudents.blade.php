					...
					<table class="styled-table">
						...
						<tbody>
							...
							<tr>
                                ...
                                <td>
                                    @if ($student->year == 1)    الأولى@endif
                                    @if ($student->year == 2)  الثانية@endif
                                    @if ($student->year == 3)  الثالثة@endif
                                    @if ($student->year == 4)  الرابعة@endif
                                    @if ($student->year == 5)  الخامسة@endif
                                </td>
