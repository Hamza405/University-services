  ...
  <div class="container-fluid" style="width: 75%;position: absolute;left: 16px;">
			<div class="db-breadcrumb">
				...
				<ul class="db-breadcrumb-list">
					<li><a href="#"><i style="padding:0px 16px" class="fa fa-home"></i>إضافة طالب</a></li>
				</ul>
			</div>	
			<!-- Card -->
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input style="direction:rtl" id="num" type="text" class="form-control" name="num" required>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="d-flex justify-content-center">
                                  <div class="text-danger" >
                                      {{ implode('', $errors->all('الرقم الجامعي مستخدم سابقا')) }}
                                  </div>
                                  @endif
                            </div> 
