                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">	
                            ...
                            <li><a href="javascript:;">خدمات <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
									<h3><i class="ti-user"></i><span class="counter">{{ $us->where('role','طالب')->count() }}</span></h3>
									</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
									<h3><i class="ti-layout-list-post"></i><span class="counter">{{$us->where('role','موظف')->count() }}</span></h3>
									</div>
