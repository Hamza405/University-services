  ...
  <div class="container-fluid" style="width: 75%;position: absolute;left: 16px;">
			<div class="db-breadcrumb">
				...
				<ul class="db-breadcrumb-list">
					<li><a href="#"><i style="padding:0px 16px" class="fa fa-home"></i>إضافة البرنامج الامتحاني</a></li>
				</ul>
			</div>	
			<!-- Add Image -->
      <div class="row">
      <div class="col-lg-8 col-md-6 mr-4">
          <form method="post" action="{{ url('/storeStudyExam') }}" 
                        enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="image" style="direction:rtl">
                          <label style="float:right"><h4 >أختر صورة</h4></label>
                          <input type="file" class="form-control" required name="image">
                      </div>
                      <div class="post_button mr-3 " style="margin-top:3rem">
                          <button type="submit" class="btn btn-success" style="float:right;background-color: transparent;"><i class="fa fa-save" style="font-size:2rem; color:purple"></i></button>
                      </div>
                    </div>
      ...
      <div class="row d-flex justify-content-center mt-2 mb-3">
        <div class="col-lg-8 col-md-6">
          <img src="public/Image/StudyExam/{{$studyExam->image}}" alt="صورة البرنامج الأمتحاني, أضف صورة">
        </div>
      </div>
	</div>
</main>
