  ...
  <div class="container-fluid" style="width: 75%;position: absolute;left: 16px;">
			<div class="db-breadcrumb">
				...
				<ul class="db-breadcrumb-list">
					<li><a href="#"><i style="padding:0px 16px" class="fa fa-home"></i>إضافة خدمة</a></li>
