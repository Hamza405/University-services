                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
						...
						<li class="active"><a href="{{ url('/home') }}">الرئيسية</a>
								<li><a href="{{url('/myMarks')}}">كافة المواد المقدمة</a>
								<li><a href="{{url('/exportOnlyPdf')}}"><i class="fa fa-print" style="font-size:0.8rem"></i></a>
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<div class="proImg" style="overflow-y:scroll;height:90vh;position: relative;top:10rem;left:5rem;z-index:1000000">
						...
						<table class="styled-table">
							<thead>
								<tr >
									<th  style="color: #fff">المادة</th>
									<th  style="color: #fff">علامة المقرر النظر</th>
									<th  style="color: #fff">علامة المقرر العملي</th>
									<th  style="color: #fff">سنة  النجاح  بالمادة</th>
									<th style="color: #fff">دورة  النجاح  بالمادة</th>
								</tr>
							</thead>
							<tbody>
								@foreach ($marks as $s)
