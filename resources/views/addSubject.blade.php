  ...
  <div class="container-fluid" style="width: 75%;position: absolute;left: 16px;">
			<div class="db-breadcrumb">
				...
				<ul class="db-breadcrumb-list">
					<li><a href="#"><i style="padding:0px 16px" class="fa fa-home"></i>إضافة مقرر دراسي</a></li>
			...
			<div class="row" style="margin-top:2rem">
				<div class="col-lg-12">
                    <form class="contact-bx" method="POST" action="{{ url('/addSubject') }}">
                        @csrf
                        <div class="row placeani">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="input-group">
                                        <label style="text-align:end">اسم المادة</label>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <select id="gender" name="semester">
                                            <option value="1">
                                                الفصل الأول
                                            </option>
                                            <option value="2">
                    ...
                    <div class="d-flex justify-content-center">
                      <div class="text-danger" >
                          {{ implode('', $errors->all('هذا المقرر مضاف مسبقا')) }}
                      </div>
                      @endif    
                            </div> 
