...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<style>
		html{
			...
			table{ text-align: center;width: 65%;border: 1px solid #f7b205; }
        ...
        <div class="rev-slider">
			<div id="rev_slider_486_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36" data-source="gallery" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<div class="proImg" style="overflow-y:scroll;height:90vh;position: relative;top:10rem;left:15rem;z-index:1000000">
						<table class="styled-table">
							<thead>
								<tr>
									<th style="color: #fff">اسم المادة</th>
									<th style="color: #fff">السنة</th>
									<th style="color: #fff">الفصل</th>
								</tr>
							</thead>
							<tbody>
